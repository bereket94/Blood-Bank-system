...
<head>
    ...
    <style>
        .modal {
            display: <?php echo isset($edit_donor) ? 'flex' : 'none'; ?>;
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
...
<body>
    <div class="container">
        <div class="header" style="background: #1a1a2e; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div class="search-box">
            <form method="GET">
                <input type="text" name="search" placeholder="Search by ID, Name, Email, or Blood Group..." value="<?php echo htmlspecialchars($search); ?>">
        ...
        <h2 style="color:red;margin-top: 11px;">All Registered Donors </h2><p style="justify-content:flex-end;color :green;margin-top: 15px; " ><strong>Total Donors:</strong> <?php echo mysqli_num_rows($donors); ?></p>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-links">
                            ...
                            <a href="?delete=<?php echo $donor['id']; ?>" onclick="return confirm('Delete this donor?')" style="color: #dc3545;">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" step="0.01" name="weight" value="<?php echo $edit_donor['weight']; ?>" required>
                    <label>Blood Group</label>
                    <select name="blood_group" required>
                        <option value="A+" <?php echo ($edit_donor['blood_group'] == 'A+') ? 'selected' : ''; ?>>A+</option>
                        <option value="A-" <?php echo ($edit_donor['blood_group'] == 'A-') ? 'selected' : ''; ?>>A-</option>
                        <option value="B+" <?php echo ($edit_donor['blood_group'] == 'B+') ? 'selected' : ''; ?>>B+</option>
                        <option value="B-" <?php echo ($edit_donor['blood_group'] == 'B-') ? 'selected' : ''; ?>>B-</option>
                        <option value="O+" <?php echo ($edit_donor['blood_group'] == 'O+') ? 'selected' : ''; ?>>O+</option>
                        <option value="O-" <?php echo ($edit_donor['blood_group'] == 'O-') ? 'selected' : ''; ?>>O-</option>
                        <option value="AB+" <?php echo ($edit_donor['blood_group'] == 'AB+') ? 'selected' : ''; ?>>AB+</option>
                        <option value="AB-" <?php echo ($edit_donor['blood_group'] == 'AB-') ? 'selected' : ''; ?>>AB-</option>
                    </select>
                ...
                <div class="modal-footer">
                    <a href="manage_donors.php" class="btn-cancel" style="padding: 10px 20px; text-decoration: none; border-radius: 5px;">Cancel</a>
